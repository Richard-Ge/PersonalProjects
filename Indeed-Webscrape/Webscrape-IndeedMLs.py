...
queries = ["machine learning intern", "machine learning"]  # update flags, certain TSVs; based on query (" intern", first two = datasci, second two = analysts...)
for query in queries:
	...
	with open("IndeedMLs.tsv", "r") as file:
		text = file.readlines()
		print()  #DEBUG
	currJKs = []
