...
queries = ["data science intern", "data science"]  # update flags, certain TSVs; based on query (" intern", first two = datasci, second two = analysts...)
for query in queries:
	...
	with open("IndeedScientists.tsv", "r") as file:
		text = file.readlines()
		print()  #DEBUG
	currJKs = []
	...
	for IDstr in jobIDs:  
		...
		if str(jobHeaderSel) == "[]":
			...
			with open("IndeedScientists.tsv", "a") as file:
